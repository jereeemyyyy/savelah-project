...
export default function BankDetailsScreen() {
    ...
    return (
        <View className="bg-gray-800 flex-1">
            <BackButton />
            <Text className="font-bold text-white text-4xl m-4">Enter Bank Account Details</Text>
            <Text className="text-lg text-gray-400 mx-4 mb-4">Receive real time updates to update your expenses whenever you make a payment.</Text>
